...
More then 7 years experience in web development. I am comfortable with both back-end and front-end code, mainly .NET platform and JavaScript.

I maintain the continuous integration and automation infrastructure and, as a result, became very familiar with the .NET Core tooling, Jenkins CI system and Docker ([docker-jenkins-slave](https://github.com/jincod/docker-jenkins-slave)).

I‘ve made OSS project to support deployment of .NET Core application at Heroku ([dotnetcore-buildpack](https://github.com/jincod/dotnetcore-buildpack)).
